...
from cloakroom.pipeline import (
    anonymize_file,
    get_file_columns,
    get_workspaces,
    restore_file,
...
def shield(
    ...
    except (CloakroomError, OSError) as exc:
...
def create_demo() -> gr.Blocks:
    ...
    with gr.Blocks(title="Cloakroom (HANDOFF B)") as demo:
        gr.Markdown(
            """
            # Cloakroom Web UI
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Cloakroom Gradio UI")
