...
from cowork_shield.exceptions import VaultCorruptedError, WorkspaceExpiredError
from cowork_shield.models import VaultData, now_iso
from cowork_shield.vault.atomic import atomic_write
from cowork_shield.vault.crypto import decrypt, derive_vault_key, encrypt
from cowork_shield.vault.migration import migrate_vault_data
