...
from cowork_shield.logging.sanitizer import sanitize_value
from cowork_shield.models import EntityType, ReplacementRecord
...
def _export_reports_pdf(rows: list[dict[str, Any]], path: Path, *, workspace_name: str) -> None:
    ...
    page = doc.new_page()
    y = 48.0
    page.insert_text((48, y), f"CoWork Shield Sanitization Report: {workspace_name}", fontsize=12)
    y += 20.0
